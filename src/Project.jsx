// Project page: Shows project inspiration and social/contact links with modal popup for info
    ...
    return (
        <div className="page-container">
            <div className="main-card-container">
                ...
                {/* Main content with project text and GitHub image */}
                <div className="main-container">
                    <div className="main-content-container">
                        <div className="text-img-container">
                            <div className="text-container">
                                <p className="text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, <br /> sed diam nonumy eirmod tempor invidunt ut</p>
                            </div>
                            <div className="img-container">
                                <a href="https://github.com/" className='link' ><img src="github.png" alt="YourGithub" className='yourPic' /></a>
                            </div>
                        </div>
                    </div>
