// About page: Shows education and skills, social/contact links, and modal popup for info
    ...
    return (
        <div className="page-container">
            <div className="main-card-container">
                ...
                {/* Main content with education and skills */}
                <div className="main-container">
                    <div className="main-content-container">
                        <div className="KN-container">
                            <div className="one-container">
                                <ul className="KN-list">
                                    <li className="knowledge-list-K">School</li>
                                    <li className="knowledge-list-M">City</li>
                                    <li className="knowledge-list-K"></li>
                                    <li className="knowledge-list-M"></li>
                                    <li className="knowledge-list-K"></li>
                                    <li className="knowledge-list-M"></li>
                                    <li className="knowledge-list-K"></li>
                                    <li className="knowledge-list-M"></li>
                            ...
                            <div className="one-container right">
                                <ul className="KN-list">
                                    <li className="knowledge-list-K"></li>
                                    <li className="knowledge-list-M"></li>
                                    <li className="knowledge-list-M"></li>
